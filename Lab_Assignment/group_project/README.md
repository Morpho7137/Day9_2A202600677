...
```text
Node.js / React UI (group_project/web/)
  │
  └── POST http://127.0.0.1:8000/chat
        │
        ▼
Python FastAPI backend (group_project/api/main.py)
  │
...
```powershell
.\.venv\Scripts\python.exe -m uvicorn group_project.api.main:app --host 127.0.0.1 --port 8000 --reload
```
...
Kết quả đánh giá chi tiết cho 15 câu hỏi trong Golden Dataset và phân tích so sánh A/B sẽ tự động được ghi đè/cập nhật vào file [results.md](evaluation/results.md).
